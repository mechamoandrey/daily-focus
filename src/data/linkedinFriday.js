/**
 * Checklist extra às sextas-feiras — post no LinkedIn.
 * Passos pensados para clareza, consistência e engajamento.
 */
...
/** Subtasks with detailed steps (short label + optional hint in the UI). */
