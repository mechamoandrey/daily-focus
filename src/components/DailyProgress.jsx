...
export function DailyProgress({
  ...
  return (
    <motion.section
      ...
      transition={{ duration: motionT, ease: [0.22, 1, 0.36, 1] }}
      className={cn(
        "rounded-3xl border border-white/[0.07] bg-gradient-to-br from-zinc-900/90 to-zinc-950/95 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.04)_inset] sm:p-8",
        className
      )}
    >
