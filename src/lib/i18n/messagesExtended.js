export const extendedMessages = {
  pt: {
    ...
    "dashboard.weekExecutionRate": "{pct}% de execução nos últimos 7 dias",
    ...
    "history.behaviorSummaryTitle": "Resumo (30 dias · vista atual)",
    "history.summaryAvg30": "Média de {pct}% de conclusão do dia no período filtrado.",
    "history.summaryBestStreak": "Melhor sequência: {n} dia(s) a 100%.",
  ...
  en: {
    ...
    "dashboard.weekExecutionRate": "{pct}% execution over the last 7 days",
    ...
    "history.behaviorSummaryTitle": "Summary (30 days · current view)",
    "history.summaryAvg30": "{pct}% average day completion in the filtered window.",
    "history.summaryBestStreak": "Best streak: {n} full day(s) at 100%.",
