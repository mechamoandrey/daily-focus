...
/** @param {{ subtasks: { done: boolean }[] }[]} allGoals @param {string} dateYmd */
...
/** @param {{ subtasks: { done: boolean }[] }} goal */
...
/**
 * @param {{ subtasks: { done: boolean }[] }[]} allGoals
 * @param {string} dateYmd
 * @param {null | { subtasks: { done: boolean }[] }} linkedinFriday
 */
