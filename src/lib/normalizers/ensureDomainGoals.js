/**
 * Garante campos de domínio multiusuário sem alterar o comportamento da UI.
 * @param {unknown} goal
 */
export function ensureGoalDomainFields(goal) {
  if (!goal || typeof goal !== "object") return goal;
  const gid =
    typeof goal.id === "string" && goal.id.length > 0 ? goal.id : undefined;
